...
public class MultiSeparateGroupGroupView : UserControl
{
    ...
    private void RemoveAllControl()
    {
        ...
        {
            if (control is MultiGroupGroupList groupList)
            {
    ...
    private void InitGroupGroupControl(AvaloniaList<GroupGroupDto> groupGroups)
    {
        ...
        {
            var control = (MultiGroupGroupList)_dataTemplate.Build(groupGroup)!;
            ...
            else if (args.Action == NotifyCollectionChangedAction.Remove)
            {
                if (args.OldItems != null && args.OldItems.Count != 0)
                {
                    foreach (var oldItem in args.OldItems)
                    {
                        ...
                        {
                            var control = (MultiGroupGroupList)_itemCollection.FirstOrDefault(d =>
    ...
    {
        if (sender is MultiGroupGroupList groupList)
        {
