...
public partial class ChatUI : UserControl
{
    ...
    public static readonly StyledProperty<ICommand> HeadClickCommnadProperty =
        AvaloniaProperty.Register<ChatUI, ICommand>(nameof(HeadClickCommnad));

    public ICommand HeadClickCommnad
    {
        get => GetValue(HeadClickCommnadProperty);
        set => SetValue(HeadClickCommnadProperty, value);
    }
