...
public abstract class CallOperatorBase : ICallSession, ICallOperator, IDisposable
{
    ...
    public CallOperatorBase(IMessageHelper messageHelper, IUserManager userManager,
        IStunServerManager stunServerManager, AppSettings appSettings, IUserSetting userSetting)
    {
    ...
    protected async Task<RTCConfiguration> GetRtcConfiguration()
    {
        ...
        var GatherTime = _appSettings.GatherTime;
        ...
        {
            urls = _appSettings.TurnServer.Url,
            username = _appSettings.TurnServer.Username,
            credential = _appSettings.TurnServer.Credential
        };
