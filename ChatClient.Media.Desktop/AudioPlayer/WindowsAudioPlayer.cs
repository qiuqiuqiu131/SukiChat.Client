...
internal class WindowsAudioPlayer : IPlatformAudioPlayer
{
    ...
    private AudioState playbackState = AudioState.Stopped;

    private AudioState PlaybackState
    {
        get => playbackState;
        set
        {
    ...
    public bool IsPlaying => playbackState == AudioState.Playing;
    ...
    {
        if (waveOut == null || activeStream == null || playbackState == AudioState.Playing)
            return Task.CompletedTask;

        try
        {
            if (playbackState == AudioState.Stopped)
    ...
    {
        if (activeStream == null || playbackState != AudioState.Playing)
            return Task.CompletedTask;
    ...
    {
        if (activeStream == null || playbackState != AudioState.Paused)
            return Task.CompletedTask;
    ...
    {
        if (activeStream == null || playbackState == AudioState.Stopped)
            return Task.CompletedTask;
